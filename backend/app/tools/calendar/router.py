...
_ROUTER_SYSTEM_PROMPT_TEMPLATE = (
	...
	"{prior_card_context}"
	"ROUTING RULES:\n"
	"1. CALL lookup_academic_calendar when the user asks about academic dates, "
	...
	"3. If AMBIGUOUS, ask a brief clarification question — do NOT call the tool.\n"
	"4. If clearly NOT calendar, return an empty message — do NOT call the tool.\n\n"
...
def _current_block_context(user_timezone: str) -> str:
	...
	return (
		...
		f"Block {block}. BYU-Pathway has 6 blocks per year: "
		f"Blocks 1-2 Winter, 3-4 Spring, 5-6 Fall. "
